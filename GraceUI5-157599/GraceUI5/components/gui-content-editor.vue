...
<view class="gui-editor">
	<!-- 选项类型选择 -->
	<view
	class="gui-flex gui-rows gui-align-contentItems-center gui-space-between gui-editor-menus gui-border-box gui-border-b">
		<text 
	...
	:style="{height:height+'px'}">
		...
		class="gui-editor-contentItems">
			...
			class="gui-flex gui-rows gui-justify-content-center gui-bg-gray" 
			style="padding:20rpx;">
				<input 
				type="text" 
